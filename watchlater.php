...
require_auth(); ?>
<?php $pageTitle = 'Streamify Pro - Watch Later';
$active = 'watchlater';
$extraHead = '<script src="assets/js/page-watchlater.js" defer></script>';
include __DIR__ . '/includes/header.php'; ?>
        <div class="container py-4 px-3 mx-auto" style="max-width: 1200px;">
          <h1 class="h2 mb-3"><i class="bi bi-list " id="sidebarToggle"></i><span data-i18n="watchLater.title">Watch Later</span></h1>
          <div id="wl-list" class="row g-3"></div>
        </div>
